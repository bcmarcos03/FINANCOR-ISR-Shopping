		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shopping App",
									"targetURL": "#comfinancorsdshoppingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfinancorsdshoppingapp-display": {
								"semanticObject": "comfinancorsdshoppingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.financor.sd.shoppingapp",
									"url": sap.ui.require.toUrl("com/financor/sd/shoppingapp")
								}
							}
						}
					}
