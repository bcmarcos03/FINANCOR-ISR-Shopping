@echo off
echo Downloading Gradle 8.3 (compatible with Java 21)...
...
if exist "%INSTALL_DIR%\gradle-%GRADLE_VERSION%" (
    echo Gradle 8.3 already installed at %INSTALL_DIR%\gradle-%GRADLE_VERSION%
    goto :end
)
...
:end
echo.
echo Gradle 8.3 installed successfully!
