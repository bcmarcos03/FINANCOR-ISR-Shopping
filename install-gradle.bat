...
SET INSTALL_DIR=%CD%\gradle-install

if exist "%INSTALL_DIR%\gradle-%GRADLE_VERSION%" (
    echo Gradle already installed at %INSTALL_DIR%\gradle-%GRADLE_VERSION%
    goto :setenv
)
...
echo %INSTALL_DIR%\gradle-%GRADLE_VERSION%\bin
echo.
